...
public:
	PhysicsObject();
	~PhysicsObject();
	virtual void Inititalize(float mass = 1, Vector3D initialPosition = Vector3D::Zero, Vector3D initialVelocity = Vector3D::Zero, Vector3D initialAcceleration = Vector3D::Zero, Vector3D initalRotation = Vector3D::Zero, float initalRadius = 1.0f);
